...
export const userReportDummyData: IUserReportResponse = {
  total_count: 10,
  user_list: [
    {
      user_id: 1,
      ...
      school: 'DSM',
      type: 'STUDENT',
      suspension_created_at: '15',
      suspension_expired_at: '7',
      user_reported_count: 1,
      feed_reported_count: 1,
      comment_reported_count: 1,
    },
    {
      user_id: 2,
      name: '전영준',
      school: 'DSM',
      type: 'STUDENT',
      suspension_created_at: '30',
      suspension_expired_at: '7',
      user_reported_count: 3,
      feed_reported_count: 1,
      comment_reported_count: 2,
    },
    {
      user_id: 3,
      name: '정우재',
      school: 'DGSW',
      type: 'STUDENT',
      suspension_created_at: '20',
      suspension_expired_at: '10',
      user_reported_count: 1,
      feed_reported_count: 0,
      comment_reported_count: 0,
    },
    {
      user_id: 4,
      name: '임동현',
      school: 'DGSW',
      type: 'STUDENT',
      suspension_created_at: '5',
      suspension_expired_at: '2',
      user_reported_count: 1,
      feed_reported_count: 2,
      comment_reported_count: 1,
    },
    {
      user_id: 5,
      ...
      school: 'DSM',
      type: 'STUDENT',
      suspension_created_at: '10',
      suspension_expired_at: '9',
      user_reported_count: 1,
      feed_reported_count: 0,
      comment_reported_count: 1,
    },
    ...
    },
    {
      ...
      type: 'STUDENT',
      suspension_created_at: '15',
      suspension_expired_at: '12',
      user_reported_count: 4,
      feed_reported_count: 1,
      comment_reported_count: 1,
    },
    {
...
export const commentReportDummyData: ICommentReportResponse = {
  total_count: 10,
  comment_list: [
    {
      feed_id: 1,
...
export const feedCommentDummyData: IFeedReportResponse = {
  total_count: 10,
  post_list: [
    {
      id: 1,
...
export const checkGraduateDummyData: IGraduateListResponse = {
  total_count: 10,
  user_list: [
    {
      user_id: 1,
