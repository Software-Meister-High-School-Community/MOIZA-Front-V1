      ...
      <S.Wrapper>
        <S.firstPage>
          <S.firstTitleDiv>
            <h3>모이자를 소개해요</h3>
            <p>
              모이자는 소프트웨어 마이스터 고등학교 간의 교류를 활발히 하기위해학생들이 직접
              기획하고 만들게 되었어요. <br />더 넓은 곳에서 활동하고싶다면? 모이자에 모여봐!
            </p>
          </S.firstTitleDiv>
          <S.BtnDiv>
            <Link to="/signup" style={{ margin: '0 40px 0 0' }}>
              <Index big text={'바로 가입하기'} yellow handleClick={() => {}} />
            </Link>
            <Link to="/login">
              <Index big text={'로그인하기'} handleClick={() => {}} />
            </Link>
          </S.BtnDiv>
          <S.arrowDiv>
